...
class Reservation_window(QMainWindow):
    ...
    def page(self):
            ...
            self.label =QLabel("Reservation")
            self.back=QPushButton("Back")
            self.back.clicked.connect(self.back_push)


            mycursor.execute("SELECT * FROM booking_information where user_name=(SELECT `user_name` FROM new_table);")
